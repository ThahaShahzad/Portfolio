...
const Contact = () => {
  return (
    <section id='Contact' className='pt-[30rem] mb-[10rem]'>
      <h3>Contact me</h3>
      <div className='mt-12'>
      ...
      <div className='flex gap-12 pt-40 justify-center items-center'>
        ...
        <a className='hover:scale-110' href='https://github.com/ThahaShahzad' target='_blank'>
          <AiFillGithub className='w-10 h-10' />
        </a>
        <a className='hover:scale-110' href='https://www.linkedin.com/in/thaha-shahzad-5493551a0/' target='_blank'>
